...
def create_sample_configs() -> Dict[str, Dict]:
    ...
    return {
        ...
        "ts_bpe": {
            "class": "huggingface",
            "path": "sample_tokenizers/ts_bpe_c.json"
        },
        "MiRe_bpe_control": {
            "class": "mire",
            "path": "sample_tokenizers/MiRe_bpe_control_c.json"
        },   
        "MiRe_bpe": {
            "class": "mire",
        ...
        "MiRe_bpe_mien": {
            "class": "mire",
            "path": "sample_tokenizers/MiRe_bpe_mien_c.json"
        },
        "MiRe_bpe_control2": {
            "class": "mire",
            "path": "sample_tokenizers/MiRe_bpe_control2_c.json"
        },  
        "srna": {
            "class": "srna",
        ...
        "MorfotokCF": {
            "class": "morfotok2",
            "path": "sample_tokenizers/MorfoTok_cf.json"
        },
    }
